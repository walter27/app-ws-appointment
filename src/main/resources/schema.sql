...
CREATE TABLE customer (
    ...
    CONSTRAINT fk_customer_entity_type FOREIGN KEY (entity_type_id) REFERENCES entity_type(id)
);
...
INSERT INTO entity_type (name, description) VALUES
('Natural Person', 'Natural Person'),
('Legal Entity', 'Legal Entity');

INSERT INTO employee (name, last_name, dni, email, phone, document_type_id) VALUES
('Juan', 'Perez', '0102030405', 'desarrolloaplicacionesec@gmail.com', '0991234567', 1);
